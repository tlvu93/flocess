...
import { handleDrag, handleDragEnd } from './utils';
...
export const PUZZLE_DIMENSION = 100; // puzzle dimension 100 x 100 px
export const PUZZLE_SCALE_VALUE = 2.0;
...
const draw = (
  ...
  const dragHandler = d3
    ...
    .on('drag', function (ev, data) {
      handleDrag(this, ev, data, svgNodes, SCALE_VALUE);
    })
    .on('end', (ev, data) => handleDragEnd(ev, data, setNode));
